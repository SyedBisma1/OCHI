...
function Footer() {
    return (
        <div className='w-full h-screen bg-zinc-900 flex gap-5'>
            <div className='w-1/2  p-20 flex flex-col h-full justify-between  '>
                <div className="headings ">
                    <h1 className='text-8xl uppercase leading-none -mb-5  font-bold'>Eye-</h1>
                    <h1 className='text-8xl uppercase leading-none -mb-5  font-bold '>Opening</h1>
                </div>
            ...
            <div className='w-1/2 p-20 '>
                ...
                <div className='dets font-light mt-[30vh] '>
                    <a className='block text-xl mb-5 border-b-[1px]  border-zinc-800' href="#">Facebok</a>
                    <a className='block text-xl mb-5 border-b-[1px] border-zinc-800' href="#">Instagram</a>
                    <a className='block text-xl mb-5 border-b-[1px] border-zinc-800' href="#">Twitter</a>
                    <a className='block text-xl mb-5 border-b-[1px] border-zinc-800' href="#">youtube</a>
